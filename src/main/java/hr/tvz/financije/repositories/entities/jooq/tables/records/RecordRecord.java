...
public class RecordRecord extends UpdatableRecordImpl<RecordRecord> implements Record8<Integer, Integer, String, LocalDateTime, String, Integer, Integer, Integer> {
    ...
    @Override
    public Row8<Integer, Integer, String, LocalDateTime, String, Integer, Integer, Integer> valuesRow() {
    ...
    @Override
    public RecordRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4, String value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RecordRecord(Integer id, Integer amount, String type, LocalDateTime recordDate, String description, Integer categoryId, Integer accountId, Integer receivingAccountId) {
        super(Record.RECORD);
