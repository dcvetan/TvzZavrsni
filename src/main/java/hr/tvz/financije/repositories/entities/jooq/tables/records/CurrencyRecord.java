...
public class CurrencyRecord extends UpdatableRecordImpl<CurrencyRecord> implements Record6<Integer, String, String, String, Long, LocalDateTime> {
    ...
    @Override
    public CurrencyRecord value5(Long value) {
    ...
    @Override
    public CurrencyRecord values(Integer value1, String value2, String value3, String value4, Long value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CurrencyRecord(Integer id, String name, String code, String symbol, Long exchangeRate, LocalDateTime lastUpdateDate) {
        super(Currency.CURRENCY);
