...
public class Keys {
    ...
    public static final ForeignKey<RecordRecord, CategoryRecord> RECORD__RECORD_CATEGORY_ID_FKEY = Internal.createForeignKey(Record.RECORD, DSL.name("record_category_id_fkey"), new TableField[] { Record.RECORD.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true);
