...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record8<Integer, String, Integer, String, String, String, Integer, Integer> {
    ...
    @Override
    public Row8<Integer, String, Integer, String, String, String, Integer, Integer> valuesRow() {
    ...
    @Override
    public AccountRecord values(Integer value1, String value2, Integer value3, String value4, String value5, String value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Integer id, String name, Integer amount, String type, String color, String source, Integer profileId, Integer currencyId) {
        super(Account.ACCOUNT);
