...
public class Currency extends TableImpl<CurrencyRecord> {
     ...
     */
    public final TableField<CurrencyRecord, LocalDate> LAST_UPDATE_DATE = createField(DSL.name("last_update_date"), SQLDataType.LOCALDATE.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Integer, ? super String, ? super String, ? super String, ? super Integer, ? super LocalDate, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Integer, ? super String, ? super String, ? super String, ? super Integer, ? super LocalDate, ? extends U> from) {
