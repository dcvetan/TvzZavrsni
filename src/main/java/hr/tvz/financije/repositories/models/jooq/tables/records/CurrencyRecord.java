...
public class CurrencyRecord extends UpdatableRecordImpl<CurrencyRecord> implements Record6<Integer, String, String, String, Integer, LocalDate> {
     ...
     */
    public void setLastUpdateDate(LocalDate value) {
        set(5, value);
    }
    ...
    @Override
    public Row6<Integer, String, String, String, Integer, LocalDate> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<Integer, String, String, String, Integer, LocalDate> valuesRow() {
    ...
    @Override
    public CurrencyRecord value6(LocalDate value) {
        setLastUpdateDate(value);
        return this;
    }

    @Override
    public CurrencyRecord values(Integer value1, String value2, String value3, String value4, Integer value5, LocalDate value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CurrencyRecord(Integer id, String name, String code, String symbol, Integer exchangeRate, LocalDate lastUpdateDate) {
        super(Currency.CURRENCY);
